...
class CriteriaView: UIView {
    ...
    let delegate: CriteriaViewDelegate
    
    init(delegate: CriteriaViewDelegate) {
        self.delegate = delegate
        super.init(frame: .zero)
        backgroundColor = UIColor(cgColor: CGColor(red: 252/255, green: 197/255, blue: 0/255, alpha: 0.5))
   ...
   @objc
    func btnRemoveTouchUpInside() {
        self.delegate.onCriteriaRemove(self)
    }
}
